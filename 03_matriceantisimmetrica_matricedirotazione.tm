...
<\body>
  ESERCITAZIONE 1: Procedura che prende in input un vettore e associa a quel
  vettore la corrispondente matrice anti-simmetrica
  ...
  <\session|maxima|default>
    ...
    ESERCITAZIONE 2: Procedura che prende in input una matrice, verifica se è
    ...
    ESERCITAZIONE 3: Procedura che prende in input una coppia di valori
