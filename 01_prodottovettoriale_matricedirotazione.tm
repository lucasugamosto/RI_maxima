...
<\body>
  ESERCITAZIONE 1: Calcolo del prodotto vettoriale e dimostrazione delle sue
  proprietà
  ...
  ESERCITAZIONE 2: Calcolo della matrice di rotazione e dimostrazione delle
  sue proprietà: la matrice di rotazione è una matrice isometrica e il
  ...
  <\session|maxima|default>
    ...
    La funzione ADJOINT permette di ottenere la matrice aggiunta, cioè
