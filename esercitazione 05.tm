...
<\body>
  <with|color|red|ESERCITAZIONE 1: Procedura che prende un vettore generico
  \Pa\Q in input e genera la matrice di rotazione R tramite la
  parametrizzazione di Cayley-Hamilton, se possibile (quindi controllare se
  la matrice I-S(a) è o meno invertibile, cioè ha determinante diverso da
  zero).>
  ...
  <\session|maxima|default>
    ...
    <|unfolded-io>
      ...
      >><with|math-font-family|rm|angolo_x><around*|(|<math-up|mat>|)>\<assign\><math-bf|block><space|0.27em><around*|(|<around*|[|s,c,\<vartheta\>|]>,s:<around*|(|<math-up|mat><rsub|3>|)><rsub|2>,c:<around*|(|<math-up|mat><rsub|2>|)><rsub|2>,\<vartheta\>:<math-up|atan2><around*|(|s,c|)>|)>>>
    </unfolded-io>
    ...
    <|unfolded-io>
      ...
      >><with|math-font-family|rm|angolo_y><around*|(|<math-up|mat>|)>\<assign\><math-bf|block><space|0.27em><around*|(|<around*|[|s,c,\<vartheta\>|]>,s:<around*|(|<math-up|mat><rsub|1>|)><rsub|3>,c:<around*|(|<math-up|mat><rsub|1>|)><rsub|1>,\<vartheta\>:<math-up|atan2><around*|(|s,c|)>|)>>>
    </unfolded-io>
    ...
    <|unfolded-io>
      ...
      >><with|math-font-family|rm|angolo_z><around*|(|<math-up|mat>|)>\<assign\><math-bf|block><space|0.27em><around*|(|<around*|[|s,c,\<vartheta\>|]>,s:<around*|(|<math-up|mat><rsub|2>|)><rsub|1>,c:<around*|(|<math-up|mat><rsub|1>|)><rsub|1>,\<vartheta\>:<math-up|atan2><around*|(|s,c|)>|)>>>
    </unfolded-io>
    ...
    <|unfolded-io>
      ...
      if a[1][1] = 0 and a[2][1] = 0 then theta:angolo_z(R) elseif a[1][1] =
      0 and a[3][1] = 0 then theta:angolo_y(R) elseif a[2][1] = 0 and a[3][1]
      = 0 then theta:angolo_x(R) else theta:angolo_gen(R),
    ...
    <|unfolded-io>
      ...
      >><with|math-font-family|rm|calcolo_R><around*|(|a|)>\<assign\><math-bf|block><space|0.27em><around*|(|<around*|[|S,<math-up|II>,<math-up|IImS>,<math-up|det>,<math-up|IIpS>,R|]>,S:<matrix|<tformat|<table|<row|<cell|0>|<cell|-<around*|(|a<rsub|3>|)><rsub|1>>|<cell|<around*|(|a<rsub|2>|)><rsub|1>>>|<row|<cell|<around*|(|a<rsub|3>|)><rsub|1>>|<cell|0>|<cell|-<around*|(|a<rsub|1>|)><rsub|1>>>|<row|<cell|-<around*|(|a<rsub|2>|)><rsub|1>>|<cell|<around*|(|a<rsub|1>|)><rsub|1>>|<cell|0>>>>>,<math-up|II>:<matrix|<tformat|<table|<row|<cell|1>|<cell|0>|<cell|0>>|<row|<cell|0>|<cell|1>|<cell|0>>|<row|<cell|0>|<cell|0>|<cell|1>>>>>,<math-up|IImS>:<math-up|II>-S,<math-up|det>:<math-up|determinant><around*|(|<math-up|IImS>|)>,<math-bf|if><space|0.27em><math-up|det>=0<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<math-up|IImS>:<math-up|invert><around*|(|<math-up|IImS>|)>,<math-up|IIpS>:<math-up|II>+S,R:<math-up|IIpS>\<cdot\><math-up|IImS>,R:<math-up|trigreduce><around*|(|R|)>,<math-bf|if><space|0.27em><around*|(|a<rsub|1>|)><rsub|1>=0\<wedge\><around*|(|a<rsub|2>|)><rsub|1>=0<space|0.27em><math-bf|then><space|0.27em>\<vartheta\>:<with|math-font-family|rm|angolo_z><around*|(|R|)><space|0.27em><math-bf|elseif><space|0.27em><around*|(|a<rsub|1>|)><rsub|1>=0\<wedge\><around*|(|a<rsub|3>|)><rsub|1>=0<space|0.27em><math-bf|then><space|0.27em>\<vartheta\>:<with|math-font-family|rm|angolo_y><around*|(|R|)><space|0.27em><math-bf|elseif><space|0.27em><around*|(|a<rsub|2>|)><rsub|1>=0\<wedge\><around*|(|a<rsub|3>|)><rsub|1>=0<space|0.27em><math-bf|then><space|0.27em>\<vartheta\>:<with|math-font-family|rm|angolo_x><around*|(|R|)><space|0.27em><math-bf|else><space|0.27em>\<vartheta\>:<with|math-font-family|rm|angolo_gen><around*|(|R|)>,<around*|[|R,\<vartheta\>|]>|)>>>
    </unfolded-io>
