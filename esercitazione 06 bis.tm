...
<\body>
  ...
  <\session|maxima|default>
    ...
    <with|color|red|ESERCITAZIONE 1: Procedura che calcola la matrice della
    cinematica diretta completa associata al robot SCARA a partire dalla
    ...
    <with|color|red|ESERCITAZIONE 2: Procedura che calcola la matrice della
    cinematica diretta completa associata al robot SFERICO (primo tipo) a
    partire dalla tabella di D-H con 6 gradi di libertà.>
  ...
  <\session|maxima|default>
    ...
    <with|color|red|ESERCITAZIONE 3: Procedura che a partire dalla tabella di
    D-H composta da 6 righe calcola la matrice di cinematica diretta completa
    del robot SFERICO di secotipo (STANFORD).>
  ...
  <\session|maxima|default>
    ...
    cinematica diretta completa associata al robot ANTROPOMORFO tenendo conto
    di tutti e 6 i gradi di libertà, il tutto a partire dai valori della
    tabella di D-H.>
