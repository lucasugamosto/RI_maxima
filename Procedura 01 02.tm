...
<\body>
  PROCEDURA PER IL CALCOLO DELLA MATRICE DI ROTAZIONE LUNGO L'ASSE X, L'ASSE
  Y E L'ASSE Z DI UN CERTO ANGOLO \<theta\>.

  <with|color|red|Procedura 1: Procedura che prende in ingresso una coppia di
  valori (asse,angolo) e verifica che l'asse appartenga alla terna x,y,z, poi
