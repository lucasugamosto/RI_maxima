...
//Siano L1, L2 e L3 le lunghezze dei link, queste hanno tutte valore pari a 100.
...
float xx = 0.0;                     //coordinate lungo x del giunto xxx-L3*cos(phi)
float yy = 0.0;                     //coordinate lungo y del giunto yyy-L3*sin(phi)
...
void draw() {
  ...
  //variazione dell'angolo phi affinchè sia possibile cambiare l'angolo totale del robot
