...
<\body>
  ...
  Sotto-funzione per il calcolo di una matrice di rotazione intorno ad un
  certo asse di un determinato angolo:
  ...
  <\session|maxima|default>
    ...
    Funzione principale in cui si vuole dimostrare verificata l'equazione
    matriciale seguente :<math|R<rsub|z><around*|(|\<gamma\>|)>=R<rsub|x><around*|(|\<pm\>\<pi\>/2|)>.R<rsub|y><around*|(|\<gamma\>|)>.R<rsub|x><around*|(|\<mp\>\<pi\>/2|)>>,
    per ogni \<gamma\>.
    ...
    <|unfolded-io>
      ...
      Ry:create_R(matrix([0],[1],[0]),gamma),
      ...
      mat_tot[1]:Rx[1].Ry.Rx[2],

      mat_tot[2]:Rx[2].Ry.Rx[1],

      for i:1 thru 3 do (

      for j:1 thru 3 do (

      if mat_tot[1][i,j] # mat_tot[2][i,j] then res:0 else res:1,
    ...
    <|unfolded-io>
      ...
      >><with|math-font-family|rm|prod_eulero><around*|(|\<alpha\>,\<gamma\>|)>\<assign\><math-bf|block><space|0.27em><around*|(|<around*|[|<math-up|Rx>,<math-up|Ry>,<math-up|Rz>,<math-up|val>,<with|math-font-family|rm|mat_tot>,<math-up|res>|]>,<math-up|Rx><rsub|1>:<with|math-font-family|rm|create_R><around*|(|<matrix|<tformat|<table|<row|<cell|1>>|<row|<cell|0>>|<row|<cell|0>>>>>,\<alpha\>|)>,<math-up|Rx><rsub|2>:<with|math-font-family|rm|create_R><around*|(|<matrix|<tformat|<table|<row|<cell|1>>|<row|<cell|0>>|<row|<cell|0>>>>>,-\<alpha\>|)>,<math-up|Ry>:<with|math-font-family|rm|create_R><around*|(|<matrix|<tformat|<table|<row|<cell|0>>|<row|<cell|1>>|<row|<cell|0>>>>>,\<gamma\>|)>,<math-up|Rz>:<with|math-font-family|rm|create_R><around*|(|<matrix|<tformat|<table|<row|<cell|0>>|<row|<cell|0>>|<row|<cell|1>>>>>,\<gamma\>|)>,<math-up|val>:<with|math-font-family|rm|control_R><around*|(|<math-up|Rx><rsub|1>|)>,<math-bf|if><space|0.27em><math-up|val>\<neq\>1<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<math-up|val>:<with|math-font-family|rm|control_R><around*|(|<math-up|Rx><rsub|2>|)>,<math-bf|if><space|0.27em><math-up|val>\<neq\>1<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<math-up|val>:<with|math-font-family|rm|control_R><around*|(|<math-up|Ry>|)>,<math-bf|if><space|0.27em><math-up|val>\<neq\>1<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<math-up|val>:<with|math-font-family|rm|control_R><around*|(|<math-up|Rz>|)>,<math-bf|if><space|0.27em><math-up|val>\<neq\>1<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<with|math-font-family|rm|mat_tot><rsub|1>:<math-up|Rx><rsub|1>\<cdot\><math-up|Ry>\<cdot\><math-up|Rx><rsub|2>,<with|math-font-family|rm|mat_tot><rsub|2>:<math-up|Rx><rsub|2>\<cdot\><math-up|Ry>\<cdot\><math-up|Rx><rsub|1>,<math-bf|for><space|0.27em>i<space|0.27em><math-bf|thru><space|0.27em>3<space|0.27em><math-bf|do><space|0.27em><around*|(|<math-bf|for><space|0.27em>j<space|0.27em><math-bf|thru><space|0.27em>3<space|0.27em><math-bf|do><space|0.27em><around*|(|<math-bf|if><space|0.27em><around*|(|<with|math-font-family|rm|mat_tot><rsub|1>|)><rsub|i,j>\<neq\><around*|(|<with|math-font-family|rm|mat_tot><rsub|2>|)><rsub|i,j><space|0.27em><math-bf|then><space|0.27em><math-up|res>:0<space|0.27em><math-bf|else><space|0.27em><math-up|res>:1,<math-bf|if><space|0.27em><math-up|res>\<neq\>1<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>|)>,<math-bf|if><space|0.27em><math-up|res>\<neq\>1<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>|)>,<math-up|return><around*|(|1|)>|)>>>
    </unfolded-io>
