...
<\body>
  ...
  <\session|maxima|default>
    ...
    <|unfolded-io>
      ...
      \ if aut1 # aut0 then return(aut1) else aut1:aut0
    ...
    <|unfolded-io>
      ...
      >><with|math-font-family|rm|calcolo_autovettore><around*|(|<math-up|mat>|)>\<assign\><math-bf|block><space|0.27em><around*|(|<around*|[|<math-up|II>,<math-up|RmII>,<math-up|adj>|]>,<math-up|II>:<matrix|<tformat|<table|<row|<cell|1>|<cell|0>|<cell|0>>|<row|<cell|0>|<cell|1>|<cell|0>>|<row|<cell|0>|<cell|0>|<cell|1>>>>>,<math-up|RmII>:R-<math-up|II>,<math-up|adj>:<math-up|adjoint><around*|(|<math-up|RmII>|)>,<with|math-font-family|rm|aut0>:<matrix|<tformat|<table|<row|<cell|0>>|<row|<cell|0>>|<row|<cell|0>>>>>,<math-bf|for><space|0.27em>i<space|0.27em><math-bf|thru><space|0.27em>3<space|0.27em><math-bf|do><space|0.27em><around*|(|<with|math-font-family|rm|aut1>:<matrix|<tformat|<table|<row|<cell|<math-up|adj><rsub|1,i>>>|<row|<cell|<math-up|adj><rsub|2,i>>>|<row|<cell|<math-up|adj><rsub|3,i>>>>>>,<math-bf|if><space|0.27em><with|math-font-family|rm|aut1>\<neq\><with|math-font-family|rm|aut0><space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|<with|math-font-family|rm|aut1>|)><space|0.27em><math-bf|else><space|0.27em><with|math-font-family|rm|aut1>:<with|math-font-family|rm|aut0>|)>,<math-up|return><around*|(|<with|math-font-family|rm|aut1>|)>|)>>>
    </unfolded-io>
    ...
    <|unfolded-io>
      ...
      >><with|math-font-family|rm|calcolo_versore><around*|(|<math-up|vet>|)>\<assign\><math-bf|block><space|0.27em><around*|(|<around*|[|<with|math-font-family|rm|norma2>,e|]>,<with|math-font-family|rm|norma2>:<sqrt|<math-up|vet><rsub|1,1><rsup|2>+<math-up|vet><rsub|2,1><rsup|2>+<math-up|vet><rsub|3,1><rsup|2>>,<math-bf|if><space|0.27em><with|math-font-family|rm|norma2>\<neq\>1<space|0.27em><math-bf|then><space|0.27em>e:<frac|1|<with|math-font-family|rm|norma2>>*<math-up|vet><space|0.27em><math-bf|else><space|0.27em>e:<math-up|vet>,<math-up|return><around*|(|<math-up|trigsimp><around*|(|<math-up|factor><around*|(|e|)>|)>|)>|)>>>
    </unfolded-io>
