...
<\body>
  ...
  <\session|maxima|default>
    ...
    <|input>
      mat_rotazione(matrix([a],[b],[c]),90)$
    </input>
  </session>

  <math|><math|<matrix|<tformat|<table|<row|<cell|<frac|<around*|(|c<rsup|2>+b<rsup|2>|)>*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+a<rsup|2>|c<rsup|2>+b<rsup|2>+a<rsup|2>>>|<cell|-<frac|<around*|(|c<rsup|3>+<around*|(|b<rsup|2>+a<rsup|2>|)>*c|)>*sin
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>*<around*|(|a*b*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>-a*b|)>|<around*|(|c<rsup|2>+b<rsup|2>+a<rsup|2>|)><rsup|<frac|3|2>>>>|<cell|-<frac|<around*|(|-b*c<rsup|2>-b<rsup|3>-a<rsup|2>*b|)>*sin
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>*<around*|(|a*c*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>-a*c|)>|<around*|(|c<rsup|2>+b<rsup|2>+a<rsup|2>|)><rsup|<frac|3|2>>>>>|<row|<cell|-<frac|<around*|(|<around*|(|-b<rsup|2>-a<rsup|2>|)>*c-c<rsup|3>|)>*sin
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>*<around*|(|a*b*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>-a*b|)>|<around*|(|c<rsup|2>+b<rsup|2>+a<rsup|2>|)><rsup|<frac|3|2>>>>|<cell|<frac|<around*|(|c<rsup|2>+a<rsup|2>|)>*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+b<rsup|2>|c<rsup|2>+b<rsup|2>+a<rsup|2>>>|<cell|-<frac|<around*|(|a*c<rsup|2>+a*b<rsup|2>+a<rsup|3>|)>*sin
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>*<around*|(|b*c*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>-b*c|)>|<around*|(|c<rsup|2>+b<rsup|2>+a<rsup|2>|)><rsup|<frac|3|2>>>>>|<row|<cell|-<frac|<around*|(|b*c<rsup|2>+b<rsup|3>+a<rsup|2>*b|)>*sin
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>*<around*|(|a*c*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>-a*c|)>|<around*|(|c<rsup|2>+b<rsup|2>+a<rsup|2>|)><rsup|<frac|3|2>>>>|<cell|-<frac|<around*|(|-a*c<rsup|2>-a*b<rsup|2>-a<rsup|3>|)>*sin
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>*<around*|(|b*c*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>-b*c|)>|<around*|(|c<rsup|2>+b<rsup|2>+a<rsup|2>|)><rsup|<frac|3|2>>>>|<cell|<frac|<around*|(|b<rsup|2>+a<rsup|2>|)>*cos
  <around*|(|<frac|\<pi\>*<sqrt|c<rsup|2>+b<rsup|2>+a<rsup|2>>|2>|)>+c<rsup|2>|c<rsup|2>+b<rsup|2>+a<rsup|2>>>>>>>>
</body>
