...
<\body>
  ESERCITAZIONE 1: Procedura che prende un vettore generico \Pa\Q in input e
  genera la matrice di rotazione R tramite la parametrizzazione di
  ...
  ESERCITAZIONE 2: Procedura che prende in ingresso una matrice di rotazione
  R e genera una matrice anti-simmetrica S.
