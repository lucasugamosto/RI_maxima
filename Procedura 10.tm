...
<\body>
  ...
  (quest'ultima è la procedura inversa della prima).
  ...
  Procedura diretta che consiste nel calcolo di:
  ...
  <\with|color|red>
    ...
    Procedura 2: Procedura che prende in ingresso una matrice, controlla che
    è di rotazione, ed in caso affermativo genera una matrice anti-simmetrica
    S, da cui trovare il versore che funge da asse di rotazione.
  </with>

  Procedura inversa che consiste nel calcolo del versore w, data una matrice
  di rotazione R e la formula inversa di Cayley:
  ...
  <\session|maxima|default>
    ...
    <|unfolded-io>
      ...
      S:trigsimp(factor(RmII.RpIIinv)),
    ...
    <|unfolded-io>
      ...
      >><with|math-font-family|rm|calcolo_S><around*|(|R|)>\<assign\><math-bf|block><space|0.27em><around*|(|<around*|[|<math-up|RT>,<with|math-font-family|rm|R_tot>,<math-up|II>,<math-up|det>,<math-up|RpII>,<math-up|RmII>,<math-up|RpIIinv>,S,e|]>,<math-bf|if><space|0.27em><math-up|scalarp><around*|(|R|)>=<math-bf|true>\<vee\><math-up|listp><around*|(|R|)>=<math-bf|true><space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<math-up|RT>:<math-up|transpose><around*|(|R|)>,<with|math-font-family|rm|R_tot>:<math-up|trigsimp><around*|(|R\<cdot\><math-up|RT>|)>,<math-up|II>:<matrix|<tformat|<table|<row|<cell|1>|<cell|0>|<cell|0>>|<row|<cell|0>|<cell|1>|<cell|0>>|<row|<cell|0>|<cell|0>|<cell|1>>>>>,<math-bf|if><space|0.27em><with|math-font-family|rm|R_tot>\<neq\><math-up|II><space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<math-up|det>:<math-up|trigsimp><around*|(|<math-up|determinant><around*|(|R|)>|)>,<math-bf|if><space|0.27em><math-up|det>\<neq\>1<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<math-up|RpII>:<math-up|trigsimp><around*|(|R+<math-up|II>|)>,<math-up|det>:<math-up|trigsimp><around*|(|<math-up|determinant><around*|(|<math-up|RpII>|)>|)>,<math-bf|if><space|0.27em><math-up|det>=0<space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|0|)>,<math-up|RmII>:<math-up|trigsimp><around*|(|R-<math-up|II>|)>,<math-up|RpIIinv>:<math-up|trigsimp><around*|(|<math-up|invert><around*|(|<math-up|RpII>|)>|)>,S:<math-up|trigsimp><around*|(|<math-up|factor><around*|(|<math-up|RmII>\<cdot\><math-up|RpIIinv>|)>|)>,e:<matrix|<tformat|<table|<row|<cell|S<rsub|3,2>>>|<row|<cell|S<rsub|1,3>>>|<row|<cell|S<rsub|2,1>>>>>>,<math-bf|if><space|0.27em>e=<matrix|<tformat|<table|<row|<cell|1>>|<row|<cell|0>>|<row|<cell|0>>>>>\<vee\>e=<matrix|<tformat|<table|<row|<cell|0>>|<row|<cell|1>>|<row|<cell|0>>>>>\<vee\>e\<neq\><matrix|<tformat|<table|<row|<cell|0>>|<row|<cell|0>>|<row|<cell|1>>>>><space|0.27em><math-bf|then><space|0.27em><math-up|return><around*|(|<around*|[|S,e|]>|)>,<with|math-font-family|rm|norma2>:<sqrt|e<rsub|1,1><rsup|2>+e<rsub|2,1><rsup|2>+e<rsub|3,1><rsup|2>>,e:<frac|1|<with|math-font-family|rm|norma2>>*e,<math-up|return><around*|(|<around*|[|S,e|]>|)>|)>>>
    </unfolded-io>

    <\unfolded-io>
      <with|color|red|(<with|math-font-family|rm|%i>5) >
    <|unfolded-io>
      R:calcolo_R(matrix([1],[1],[0]))
    <|unfolded-io>
    ...
    <|unfolded-io>
      ...
      >><around*|[|<matrix|<tformat|<table|<row|<cell|0>|<cell|-1>|<cell|0>>|<row|<cell|1>|<cell|0>|<cell|0>>|<row|<cell|0>|<cell|0>|<cell|0>>>>>,<matrix|<tformat|<table|<row|<cell|0>>|<row|<cell|0>>|<row|<cell|1>>>>>|]>>>
    </unfolded-io>
  </session>
